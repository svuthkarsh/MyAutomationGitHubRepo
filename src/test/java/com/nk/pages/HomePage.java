...
public class HomePage extends BasePageObject
{
	...
	public HomePage verifyHomePageTitle() throws Exception
	{
		...
		try 
		{
			...
			throw new Exception("FAILED GETING THE HOMEPAHE TITLE SITE " + "\n verifyHomePageTitle " +e.getLocalizedMessage());
		}
		return this;
	}
	/**********************************************************************************************************************/	
...
/*****************************************************************************************************************************************************/	
	...
	public LoginRecruitNaukriPage clickEmployerZone() throws Exception
	{
		...
		try 
		{
			...
			/*for (String	 Childemployee : uiDriver.getWindowHandles()) 
			{
				uiDriver.switchTo().window(Childemployee);
			}*/
	...
	public RecruitNaukriPage clickOnBuyOnLineSubMenu() throws Exception
	{
		...
		try 
		{
			...
			WebElement buyonline= uiDriver.findElement(Buyonline);
			mouseover(Buyonline);
			waitImplicit();
	...
	public SearchResultJobDescriptionPage getJobsBYLocationsName() throws Exception
	{
